...
const hours={aguilas:8,reus:9,l3h2:24,campers:30,tinamus:10,'el-ejido-outsourced-last-mile':0};
const probabilityLoss={aguilas:.25,reus:.16,l3h2:.23,campers:.31,tinamus:.29,'el-ejido-outsourced-last-mile':.35};
...
export function criticalVariable(id){return({aguilas:'valor post-conversión',reus:'ocupación',l3h2:'días alquilados / ocupación',campers:'ADR × ocupación',tinamus:'valor post-cambio y reforma','el-ejido-outsourced-last-mile':'volumen × margen por paquete'})[id]}
export function dataConfidence(id){return({aguilas:.4,reus:.6,l3h2:.6,campers:.4,tinamus:.4,'el-ejido-outsourced-last-mile':.3})[id]}
