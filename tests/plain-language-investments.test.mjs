...
test('plain-language registry exposes the requested, unique routes',()=>{
  assert.deepEqual(Object.keys(bySlug).sort(),['aguilas','castellon','el-ejido','madrid-agencia','oliva-hibrida-habitaciones','talavera']);
  assert.equal(new Set(registry.investments.map(item=>item.page)).size,6);
